...
class Settings(BaseSettings):
    ...
    local_llm_endpoint: str = Field(default="http://localhost:11434", alias="LOCAL_LLM_ENDPOINT")
    ...
    transcripts_dir: str = Field(default="./storage/transcripts", alias="TRANSCRIPTS_DIR")
    generated_docs_dir: str = Field(default="./storage/generated", alias="GENERATED_DOCS_DIR")

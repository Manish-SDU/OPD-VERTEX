...
UC-2 & Doctor & Book or start a patient consultation. & Doctor confirms or opens an appointment, starts the linked consultation, selects the patient context, and begins recording. \\
\rowcolor{VertexTableStripe}
...
\rowcolor{VertexTableStripe}
UC-5 & Patient & Book appointments and view own clinical information. & Patient logs in with email/password, books an appointment for themselves, and sees only their own appointments, consultations, and prescriptions. \\

...
\rowcolor{VertexTableStripe}
UC-5 & Patient & Book appointments and view own clinical information. & Patient logs in, books an appointment for themselves, and sees only their own appointments, consultations, and prescriptions. \\

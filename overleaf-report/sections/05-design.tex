...
\begin{tikzpicture}[
  step/.style={rounded corners=1.5mm, align=center, text width=3.25cm, minimum height=1.85cm, font=\small, inner sep=3mm},
  external/.style={step, draw=VertexBlue!75, fill=VertexBlue!8},
  boundary/.style={step, draw=VertexTeal!75, fill=VertexTeal!9},
  workflow/.style={step, draw=VertexAmber!80, fill=VertexAmber!10},

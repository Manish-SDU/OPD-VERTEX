...
The diagram uses color as a semantic grouping: blue marks external clinic or public-sector services, teal marks the Med Flow integration boundary, and amber marks the clinical documentation workflow owned by the doctor-facing system.

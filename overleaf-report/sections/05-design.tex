...
Med Flow was designed as a privacy-first, locally hosted clinical assistant for outpatient departments. The design principles translate the privacy and AI-governance concerns from the problem analysis into implementation boundaries\refcite{3,5,12}. Five principles guided the design decisions:

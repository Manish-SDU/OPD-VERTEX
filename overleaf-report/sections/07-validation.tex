...
The module-level inventory is retained in Appendix~\ref{app:test-inventory}. Raw benchmark numbers are listed in Appendix~\ref{app:benchmark-results}, the manual browser checklist in Appendix~\ref{app:manual-ui}, the hallucination matrix in Appendix~\ref{app:hallucination-matrix}, and the hardware envelope in Appendix~\ref{app:hardware-envelope}.

\begin{figure}[htbp]
\centering
\optionalgraphic[width=0.82\textwidth]{assets/charts/test_distribution.png}
\caption{Automated test distribution by category, showing the 326-test suite split across unit, integration, smoke, stress, and benchmark tiers.}
\end{figure}

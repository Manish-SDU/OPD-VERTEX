...
The numerical results are listed in Appendix~\ref{app:benchmark-results}, which keeps the evidence inspectable without adding another chart to the main report.

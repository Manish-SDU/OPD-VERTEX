...
\tablehead{Tier} & \tablehead{$n$} & \tablehead{Coverage focus} \\
\TableMidRule
...
\TableTopRule
\rowcolor{VertexTableBlue}
\tablehead{Model} & \tablehead{Params} & \tablehead{VRAM} & \tablehead{p95} & \tablehead{JSON} & \tablehead{Halluc.} & \tablehead{Verdict} \\
\TableMidRule
\rowcolor{VertexTableStripe}

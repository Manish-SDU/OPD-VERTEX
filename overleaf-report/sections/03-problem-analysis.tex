...
To reduce the risk of data leaks and internet dependency, Med Flow is designed as a locally hosted system using open-source LLMs deployed on the clinic's internal network. This architecture aims to keep audio processing, transcription, and document generation local, ensuring that sensitive data remains private and under the clinic's control.
